...
public class FileCopyClient extends Thread {
    ...
    public FileCopyClient(String serverArg, String sourcePathArg,
        ...
        try {
            ...
            outToFile = new FileOutputStream("/home/stud38/aaz815/NetBeansProjects/RN_FileCopy/nature.jpg");
    ...
    private void runFileCopyClient() {
        ...
        try {
            //sendePuffer.start();
            clientSocket = new DatagramSocket(60000, InetAddress.getByName("lab21"));
        } catch (Exception ex) {
            Logger.getLogger(FileCopyClient.class.getName()).log(Level.SEVERE, null, ex);
...
//        System.out.println("<<<ALLE PAKETE IM PUFFER>>>");
        ...
        sendePuffer.waitForEmptyPuffer();
    ...
    private FCpacket getNextPackage(long seqNum) {
        ...
        if (laenge >= 0) {
            result = new FCpacket(seqNum, data, laenge);
        } else {
            result = null;
        }
